/* 
- Planiranje aplikacije, uključivanje JS skripte u html
- Tipovi podataka
- Izjave 
- Funkcije
- Objekti
...
- DOM manipulacija
- OOP tehnike
- Obrasci - module obrazac koji se neporsredno izvršava 
*/
...
(function () {
  function Todo() {
    ...
    function removeAllCompleted() {
      var listItems = list.getElementsByTagName('li');
      for (var i = listItems.length - 1; i >= listItems.length; i--) {
        var check = listItems[i].getElementsByTagName('input');
        if (check[0].checked) {
          listItems[i].remove();
        }
